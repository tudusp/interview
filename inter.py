...
with tab3:
    ...
    col1, col2 = st.columns(2)
    with col1:
        meet_link = st.text_input("Meeting Link or Message (Optional)", 
                                 placeholder="Enter your custom meeting link or message",
                                 help="Enter any meeting link (Google Meet, Zoom, etc.) or custom message")
    ...
    if st.button("Schedule Interviews"):
        if interview_group in st.session_state.groups and interview_panel in st.session_state.panels:
            ...
            <p>You have been assigned to conduct interviews for the following candidates:</p>
